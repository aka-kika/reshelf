...
- **Save by link** — `reshelf://add?url=<GitHub repo URL>` saves a repo into The Collector from another app (Undrdr Drop's "Send to reshelf"); duplicates are only selected.
